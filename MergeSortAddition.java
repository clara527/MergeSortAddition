...
public class MergeSortAddition {
    ...
    public static void main(String[] args) {
        ...
        if (option == 1) {
            ...
            System.out.print("Input the name of the file to read array");
            String name = scanner.nextLine();
            System.out.print("Input the name of the file you want the sorted array to be saved to ");
            String outputFile = scanner.nextLine();
            ...
            System.out.println("Your input is not valid please enter 1, 2, or 3");
        }
    }
}